...
const EXPERIMENTS = [
  ...
  {
    id: "analise-dimensional-periodo-de-um-pendulo", topic: "Dimensões, grandezas e unidades em Física", name: "Análise dimensional: período de um pêndulo",
  ...
  {
    id: "medicao-de-grandezas-em-fisica", topic: "Dimensões, grandezas e unidades em Física", name: "Medição de grandezas em física",
  ...
  // --- Cinemática ---
  {
    id: "nocao-de-ponto-material", topic: "Cinemática", name: "Noção de ponto material",
  ...
  {
    id: "queda-de-grave-posicao-velocidade-e-aceleracao", topic: "Cinemática", name: "Bola em queda livre",
  ...
  { id: "queda-de-graves", topic: "Cinemática", name: "Projéteis", objetivo: "", equipamento: "", procedimento: "" },
  {
    id: "lancamento-de-graves-com-diferentes-componentes-das-velocidades-iniciais", topic: "Cinemática", name: "Tempos de queda de um grave com diferentes velocidades iniciais",
  ...
  {
    id: "tiro-ao-alvo", topic: "Cinemática", name: "Projéteis e tiro ao alvo",
  ...
  {
    id: "velocidade-tangencial-velocidade-angular-e-raio-da-trajetoria", topic: "Cinemática", name: "Velocidade tangencial, velocidade angular e raio da trajetória",
  ...
  {
    id: "carro-balistico", topic: "Cinemática", name: "Carro balístico",
  ...
  { id: "lei-de-hooke", topic: "Dinâmica - Leis de Newton", name: "Lei de Hooke", objetivo: "", equipamento: "", procedimento: "" },
  {
    id: "forca-de-atrito", topic: "Dinâmica - Leis de Newton", name: "Força de atrito",
  ...
  {
    id: "forca-centriipeta", topic: "Dinâmica - Leis de Newton", name: "Força centrípeta",
  ...
  {
    id: "pendulo-conico", topic: "Dinâmica - Leis de Newton", name: "Pêndulo cónico",
  ...
  {
    id: "calha-com-looping", topic: "Dinâmica - Leis de Newton", name: "Calha com looping",
  ...
  {
    id: "roldanas", topic: "Dinâmica - Leis de Newton", name: "Roldanas",
  ...
  {
    id: "acao-reacao", topic: "Dinâmica - Leis de Newton", name: "Ação-reação",
  ...
  {
    id: "pendulo-balistico", topic: "Momento linear e colisões", name: "Pêndulo balístico",
  ...
  {
    id: "colisoes-elasticas-em-calha-de-ar", topic: "Momento linear e colisões", name: "Colisões elásticas em calha de ar",
  ...
  {
    id: "pendulo-de-newton", topic: "Momento linear e colisões", name: "Pêndulo de Newton",
  ...
  {
    id: "colisoes-inelasticas-em-calha-de-ar", topic: "Momento linear e colisões", name: "Colisões inelásticas em calha de ar",
  ...
  // --- Corpo rígido ---
  {
    id: "balanca-e-momento-de-forcas", topic: "Corpo rígido", name: "Balança e momento de forças",
  ...
  {
    id: "equilibrio-de-estrutura-metalica", topic: "Corpo rígido", name: "Equilíbrio de estrutura metálica",
  ...
  {
    id: "dinamica-do-corpo-rigido-e-centro-de-massa", topic: "Corpo rígido", name: "Dinâmica do corpo rígido e centro de massa",
  ...
  {
    id: "corpos-rigidos-em-rotacao-em-plano-inclinado", topic: "Corpo rígido", name: "Inércia rotacional: corpos rígidos em rotação em plano inclinado",
  ...
  {
    id: "rotacao-de-uma-roda-de-bicicleta-e-momento-angular", topic: "Corpo rígido", name: "Rotação de uma roda de bicicleta e momento angular",
  ...
  {
    id: "modelo-de-braco-e-lancamento-de-bola", topic: "Corpo rígido", name: "Modelo mecânico de braço humano",
  ...
  {
    id: "conservacao-de-momento-angular-em-sistema-com-dois-discos", topic: "Corpo rígido", name: "Conservação de momento angular em sistema com dois discos",
  ...
  {
    id: "conservacao-de-momento-angular-com-banco-giratorio", topic: "Corpo rígido", name: "Conservação de momento angular com banco giratório e pesos",
  ...
  {
    id: "giroscopio-f4b", topic: "Corpo rígido", name: "Giroscópio",
  ...
  {
    id: "piao-que-inverte-a-rotacao-tippe-top-a35", topic: "Corpo rígido", name: "Pião que inverte a rotação: tippe top",
  ...
  {
    id: "giroscopio-manual", topic: "Corpo rígido", name: "Giroscópio manual",
    objetivo: "Observar o movimento de um giroscópio.",
  ...
  {
    id: "centro-de-massa-e-equilibrio-de-um-corpo-rigido---1", topic: "Corpo rígido", name: "Centro de massa e equilíbrio de um corpo rígido - 1",
  ...
  // --- Oscilações ---
  {
    id: "equilibrio-estavel-e-equilibrio-instavel", topic: "Oscilações", name: "Equilíbrio estável e equilíbrio instável",
  ...
  {
    id: "oscilacoes-livres-de-uma-massa-presa-a-molas-numa-calha", topic: "Oscilações", name: "Oscilações livres de uma massa presa a molas numa calha",
  ...
  {
    id: "oscilacoes-livres-em-massa-mola", topic: "Oscilações", name: "Oscilações livres em massa mola",
  ...
  {
    id: "oscilacoes-de-massa-suspensa-a-mola", topic: "Oscilações", name: "Oscilações de massa suspensa a mola",
  ...
  {
    id: "oscilacao-de-massa-suspensa-em-mola---amortecidas", topic: "Oscilações", name: "Oscilação de massa suspensa em mola - amortecidas",
  ...
  {
    id: "ressonancia-em-sistema-massa-mola", topic: "Oscilações", name: "Ressonância em sistema massa-mola",
  ...
  {
    id: "oscilacoes-de-duas-massas-acopladas", topic: "Oscilações", name: "Oscilações de duas massas acopladas",
  ...
  {
    id: "oscilacoes-de-pendulos-acoplados", topic: "Oscilações", name: "Oscilações de pêndulos acoplados",
  ...
  {
    id: "pendulo", topic: "Oscilações", name: "Pêndulo",
  ...
  // --- Ondas ---
  {
    id: "ondas-longitudunais-em-mola", topic: "Ondas", name: "Ondas longitudinais em mola",
  ...
  {
    id: "demonstrador-de-ondas-mecanicas-transversais", topic: "Ondas", name: "Demonstrador de ondas mecânicas transversais",
  ...
  {
    id: "ondas-em-tina-de-ondas-com-agua", topic: "Ondas", name: "Ondas em tina de ondas com água",
  ...
  {
    id: "ondas-transversais-em-corda-nocoes-fundamentais", topic: "Ondas", name: "Ondas transversais em corda: noções fundamentais",
  ...
  {
    id: "ondas-sonoras-transformada-de-fourier-de-um-sinal-sonoro", topic: "Ondas", name: "Ondas sonoras: transformada de Fourier de um sinal sonoro",
  ...
  { id: "espectroscopia", topic: "Ondas", name: "Espectroscopia", objetivo: "", equipamento: "", procedimento: "" },
  {
    id: "refracao-de-luz", topic: "Ondas", name: "Refração da luz. Refração total",
    objetivo: "Demonstração do comportamento da luz na fronteira entre dois meios: refração e ângulo crítico.",
    equipamento: "", procedimento: ""
  },
  {
    id: "dispersao-de-luz", topic: "Ondas", name: "Dispersão de luz",
  ...
  {
    id: "reflexao-de-luz-1d0", topic: "Ondas", name: "Reflexão de luz em superfícies espelhadas",
    objetivo: "Visualização da reflexão da luz em superfícies espelhadas.",
    equipamento: "Superfícies espelhadas, planas e curvas.",
    procedimento: ""
  },
  {
    id: "mola-reflexao-de-onda-em-extremidade-livre-ou-fixa", topic: "Ondas", name: "Mola - reflexão de onda em extremidade livre ou fixa",
  ...
  {
    id: "lei-de-snell-decartes-e-angulo-critico-na-fronteira-agua-ar", topic: "Ondas", name: "Lei de Snell-Descartes e ângulo crítico para a luz na fronteira água-ar",
  ...
  {
    id: "fibra-otica-com-agua", topic: "Ondas", name: "Fibra ótica com água",
  ...
  {
    id: "fibras-oticas", topic: "Ondas", name: "Fibras óticas",
  ...
  {
    id: "guitarra", topic: "Ondas", name: "Guitarra",
  ...
  {
    id: "figuras-de-chladni", topic: "Ondas", name: "Figuras de Chladni",
  ...
  {
    id: "interferometro-de-michelson", topic: "Ondas", name: "Interferómetro de Michelson",
  ...
  {
    id: "ondas-com-frequencias-iguais", topic: "Ondas", name: "Ondas sonoras com frequências iguais",
  ...
  {
    id: "polarizacao-de-ondas-mecanicas", topic: "Ondas", name: "Polarização de ondas mecânicas",
  ...
  {
    id: "polarizacao-de-ondas-eletromagneticas-e-filtros-polarizadores", topic: "Ondas", name: "Polarização de ondas eletromagnéticas e filtros polarizadores",
  ...
  {
    id: "sobreposicao-de-ondas-sonoras-com-frequencias-proximas-batimentos", topic: "Ondas", name: "Sobreposição de ondas sonoras com frequências próximas: batimentos",
  ...
  // --- Banco ótico ---
  {
    id: "banco-otico-sistemas-com-lentes-concavas-e-convexas", topic: "Banco ótico", name: "Banco ótico: sistemas com lentes côncavas e convexas",
  ...
  // --- Eletromagnetismo ---
  { id: "cargas-campos-e-potencial-eletrostatico", topic: "Eletromagnetismo", name: "Cargas, campos e potencial eletrostático", objetivo: "", equipamento: "", procedimento: "" },
  { id: "dieletricos-e-condensador-plano", topic: "Eletromagnetismo", name: "Dielétricos e condensador plano", objetivo: "", equipamento: "", procedimento: "" },
  { id: "lei-de-lenz", topic: "Eletromagnetismo", name: "Lei de Lenz", objetivo: "", equipamento: "", procedimento: "" },
  {
    id: "inducao-eletromagnetica-de-faraday", topic: "Eletromagnetismo", name: "Indução eletromagnética de Faraday",
  ...
  {
    id: "coijclkn", topic: "Eletromagnetismo", name: "Linhas de campo magnético",
  ...
  {
    id: "visualizacao-3d-de-linhas-de-campo-magnetico", topic: "Eletromagnetismo", name: "Visualização a 3D de linhas de campo magnético criado por um íman",
    objetivo: "",
  ...
  {
    id: "termometro-de-galileo", topic: "Termodinâmica e Física estatística", name: "Medição de temperatura com termómetro de Galileo",
  ...
  {
    id: "transicao-de-fase-agua-vapor-a-baixa-pressao", topic: "Termodinâmica e Física estatística", name: "Transição de fase água-vapor a baixa pressão",
  ...
  // --- Mecânica de Fluidos ---
  {
    id: "impulsao-do-ar", topic: "Mecânica de Fluidos", name: "Impulsão do ar",
  ...
  {
    id: "impulsao-no-interior-de-um-liquido", topic: "Mecânica de Fluidos", name: "Impulsão no interior de um líquido",
  ...
  {
    id: "pressao-do-ar-hemisferios-de-magdeburgo", topic: "Mecânica de Fluidos", name: "Pressão do ar: hemisférios de Magdeburgo",
  ...
  {
    id: "diabo-mergulhador", topic: "Mecânica de Fluidos", name: "Diabo mergulhador",
  ...
  {
    id: "impulsao-em-agua-e-no-ar-comparacao", topic: "Mecânica de Fluidos", name: "Impulsão em água e no ar: comparação",
  ...
  {
    id: "elevador-hidraulico", topic: "Mecânica de Fluidos", name: "Elevador hidráulico",
  ...
  {
    id: "escoamento-em-tubos", topic: "Mecânica de Fluidos", name: "Escoamento de água e equação de Bernoulli",
  ...
  // --- Mecânica quântica ---
  {
    id: "lampadas-espetrais", topic: "Mecânica quântica", name: "Espetros",
  ...
  {
    id: "detecao-de-radiacao-infra-vermelha", topic: "Mecânica quântica", name: "Deteção de radiação infravermelha",
  ...
  {
    id: "radiometro-de-crookes", topic: "Mecânica quântica", name: "Radiómetro de Crookes",
  ...
  {
    id: "difracao-de-eletroes", topic: "Mecânica quântica", name: "Dualismo onda-partícula e difração de eletrões",
  ...
  // --- Relatividade ---
  {
    id: "principio-de-equivalencia", topic: "Relatividade", name: "Princípio de equivalência",
